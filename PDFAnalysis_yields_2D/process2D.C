...
void process2D(std::string fileName, std::string sampleName, std::string genPdf)
{
    ...
    Float_t ymin    = h1_temp->GetYaxis()->GetYmin();
    Float_t ymax    = h1_temp->GetYaxis()->GetYmax();
    delete h1_temp;
    ...
    // central
    TH2F *h1_CT10   = new TH2F(Form("%s_h1_CT10", sampleName.c_str()),  "centre", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    TH2F *h1_CT10_up   = new TH2F(Form("%s_h1_CT10_up", sampleName.c_str()),  "centre up", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    TH2F *h1_CT10_down  = new TH2F(Form("%s_h1_CT10_down", sampleName.c_str()), "centre down", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    AnalyseCTMSTW(f, sampleName, "CT10", 53, h1_CT10, h1_CT10_up, h1_CT10_down);

    // alpha_s
    TH2F *h1_CT10_alpha_S   = new TH2F(Form("%s_h1_CT10_alpha_S", sampleName.c_str()),  "alpha_S", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    TH2F *h1_CT10_alpha_S_up   = new TH2F(Form("%s_h1_CT10_alpha_S_up", sampleName.c_str()),  "alpha_S up", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    TH2F *h1_CT10_alpha_S_down  = new TH2F(Form("%s_h1_CT10_alpha_S_down", sampleName.c_str()), "alpha_S down", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    ...
    TH2F *h1_CT10_env_up   = new TH2F(Form("%s_h1_CT10_env_up", sampleName.c_str()),  "CT10 up", nbinsx, xmin, xmax, nbinsy, ymin, ymax);    
    TH2F *h1_CT10_env_down   = new TH2F(Form("%s_h1_CT10_env_down", sampleName.c_str()),  "CT10 down", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    ...
    TH2F *h1_MSTW      = new TH2F(Form("%s_h1_MSTW", sampleName.c_str()),  "centre", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    TH2F *h1_MSTW_up   = new TH2F(Form("%s_h1_MSTW_up", sampleName.c_str()),  "centre up", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    TH2F *h1_MSTW_down = new TH2F(Form("%s_h1_MSTW_down", sampleName.c_str()), "centre down", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    AnalyseCTMSTW(f, sampleName, "MSTW2008nlo68cl", 41, h1_MSTW, h1_MSTW_up, h1_MSTW_down);

    TH2F *h1_MSTW_asup      = new TH2F(Form("%s_h1_MSTW_asup", sampleName.c_str()),  "asup", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    TH2F *h1_MSTW_asup_up   = new TH2F(Form("%s_h1_MSTW_asup_up", sampleName.c_str()),  "asup up", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    TH2F *h1_MSTW_asup_down = new TH2F(Form("%s_h1_MSTW_asup_down", sampleName.c_str()), "asup down", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    ...
    TH2F *h1_MSTW_asdown      = new TH2F(Form("%s_h1_MSTW_asdown", sampleName.c_str()),  "asdown", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    TH2F *h1_MSTW_asdown_up   = new TH2F(Form("%s_h1_MSTW_asdown_up", sampleName.c_str()),  "asdown up", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    TH2F *h1_MSTW_asdown_down = new TH2F(Form("%s_h1_MSTW_asdown_down", sampleName.c_str()), "asdown down", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    ...
    TH2F *h1_MSTW_asup05      = new TH2F(Form("%s_h1_MSTW_asup05", sampleName.c_str()),  "asup05", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    TH2F *h1_MSTW_asup05_up   = new TH2F(Form("%s_h1_MSTW_asup05_up", sampleName.c_str()),  "asup05 up", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    TH2F *h1_MSTW_asup05_down = new TH2F(Form("%s_h1_MSTW_asup05_down", sampleName.c_str()), "asup05 down", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    ...
    TH2F *h1_MSTW_asdown05      = new TH2F(Form("%s_h1_MSTW_asdown05", sampleName.c_str()),  "asdown05", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    TH2F *h1_MSTW_asdown05_up   = new TH2F(Form("%s_h1_MSTW_asdown05_up", sampleName.c_str()),  "asdown05 up", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    TH2F *h1_MSTW_asdown05_down = new TH2F(Form("%s_h1_MSTW_asdown05_down", sampleName.c_str()), "asdown05 down", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    ...
    TH2F *h1_MSTW_env_up   = new TH2F(Form("%s_h1_MSTW_env_up", sampleName.c_str()),  "MSTW up", nbinsx, xmin, xmax, nbinsy, ymin, ymax);    
    TH2F *h1_MSTW_env_down = new TH2F(Form("%s_h1_MSTW_env_down", sampleName.c_str()),  "MSTW down", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    ...
    TH2F *h1_NNPDF      = new TH2F(Form("%s_h1_NNPDF", sampleName.c_str()),  "centre", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    TH2F *h1_NNPDF_up   = new TH2F(Form("%s_h1_NNPDF_up", sampleName.c_str()),  "centre up", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    TH2F *h1_NNPDF_down = new TH2F(Form("%s_h1_NNPDF_down", sampleName.c_str()), "centre down", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    ...
    TH2F *h1_GenPDF = (TH2F*)f->Get(Form("%s_%s", sampleName.c_str(), genPdf.c_str()))->Clone("GenPDF");
    TH2F *h1_env_up   = new TH2F(Form("%s_h1_env_up", sampleName.c_str()),  "up", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    TH2F *h1_env_down   = new TH2F(Form("%s_h1_env_down", sampleName.c_str()),  "down", nbinsx, xmin, xmax, nbinsy, ymin, ymax);
    ...
    for (int binx = 0; binx < h1_GenPDF->GetNbinsX() + 1; ++binx) 
      for (Int_t biny = 1; biny <= h1->GetNbinsY(); ++biny) {
        ...
        h1_env_up->SetBinContent(binx,biny,    TMath::Max(TMath::Max(up_NNPDF,     up_CT10),   up_MSTW));
        h1_env_down->SetBinContent(binx,biny,  TMath::Min(TMath::Min(down_NNPDF,   down_CT10), down_MSTW));
    }
    ...
    TH2F* h1_env_midpoint = (TH2F*)h1_env_up->Clone("h1_env_midpoint");
    ...
    // compute the ratios
    TH2F *h1_ratio = (TH2F*)h1_env_midpoint->Clone("h1_ratio");
    h1_ratio->Divide(h1_GenPDF);
    TH2F *h1_ratioUp = (TH2F*)h1_env_up->Clone("h1_ratioUp");
    h1_ratioUp->Divide(h1_GenPDF);
    TH2F *h1_ratioDown = (TH2F*)h1_env_down->Clone("h1_ratioDown");
    h1_ratioDown->Divide(h1_GenPDF);

    TH2F *h1_ratioCT10 = (TH2F*)h1_CT10->Clone("h1_ratioCT10");
    h1_ratioCT10->Divide(h1_GenPDF);
    TH2F *h1_ratioCT10Up = (TH2F*)h1_CT10_env_up->Clone("h1_ratioCT10Up");
    h1_ratioCT10Up->Divide(h1_GenPDF);
    TH2F *h1_ratioCT10Down = (TH2F*)h1_CT10_env_down->Clone("h1_ratioCT10Down");
    h1_ratioCT10Down->Divide(h1_GenPDF);

    TH2F *h1_ratioMSTW = (TH2F*)h1_MSTW->Clone("h1_ratioMSTW");
    h1_ratioMSTW->Divide(h1_GenPDF);
    TH2F *h1_ratioMSTWUp = (TH2F*)h1_MSTW_env_up->Clone("h1_ratioMSTWUp");
    h1_ratioMSTWUp->Divide(h1_GenPDF);
    TH2F *h1_ratioMSTWDown = (TH2F*)h1_MSTW_env_down->Clone("h1_ratioMSTWDown");
    h1_ratioMSTWDown->Divide(h1_GenPDF);

    TH2F *h1_ratioNNPDF = (TH2F*)h1_NNPDF->Clone("h1_ratioNNPDF");
    h1_ratioNNPDF->Divide(h1_GenPDF);
    TH2F *h1_ratioNNPDFUp = (TH2F*)h1_NNPDF_up->Clone("h1_ratioNNPDFUp");
    h1_ratioNNPDFUp->Divide(h1_GenPDF);
    TH2F *h1_ratioNNPDFDown = (TH2F*)h1_NNPDF_down->Clone("h1_ratioNNPDFDown");
